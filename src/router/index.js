...
export const constantRoutes = [
   ...
   */
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'cs_new_request',
        meta: { title: 'linkcs_create' }
      },
      {
        path: 'list',
        component: () => import('@/views/linkcs/list'),
        name: 'linkcs_list',
        meta: { title: 'linkcs_list' }
      }
    ]
  },
  {
  ...
  },
  {
    path: '/dev',
    component: Layout,
    meta: { title: 'develop', icon: 'bug' },
    children: [
      {
        path: 'debug',
        component: () => import('@/views/develop/debug'),
        name: 'dev_debug_option',
        meta: { title: 'dev_debug_option', icon: 'bug' }
      }
    ]
  },
